...
#HOMO/LUMO Train
data=np.load('HL_INPUT.npy',allow_pickle=True).item()
...
train_data.to_csv("./Unimolsave/COS2_train.csv", index=False)
...
clf = MolTrain(task='multilabel_regression',
                    ...
                    metrics='mae',
                    split='random',
                    save_path='./Unimolsave',
                    kfold=5,
                    remove_hs=True,
                  )


clf.fit("./Unimolsave/COS2_train.csv")
